			...
			controller: {
				...
				JCasC: {
					...
					configScripts: {
						"welcome-message": """
jenkins:
  systemMessage: "hi dodo ci/cd"
"""
					}
					securityRealm: """
oic:
  clientId: "cb8a7185-10bd-41d2-96e4-4bbd92459a29"
  clientSecret: "7~KBsLYjJY43musUA-WbhO2Xli"
  wellKnownOpenIDConfigurationUrl: "https://hydra.v0.dodo.cloud/.well-known/openid-configuration"
  userNameField: "email"
"""
				}
			}
